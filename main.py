...
movies_list = pickle.load(open('E:/Cmnd-line-gpu/Projects/Models/movies_dict.pkl', 'rb'))
movies_list = pd.DataFrame(movies_list)

similarity = pickle.load(open('E:/Cmnd-line-gpu/Projects/Models/similarity.pkl', 'rb'))
credit = pickle.load(open('E:/Cmnd-line-gpu/Projects/Models/credits_dict.pkl', 'rb'))
credit_list = pd.DataFrame(credit)

st.title('Movie Recommender System')

option = st.selectbox("Which movie would you like to watch!", movies_list['title'].values)
